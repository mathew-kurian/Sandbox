...
class oxylus.template.portfolio.thumb extends MovieClip
{
	...
	public function setNode(n:XMLNode, settings_:Object) {
		...
		drawOval(second["normal"]["a"], settings.thumbWidth + 2 + 10, 41, 0, 0xffffff, 70);
		drawOval(second["normal"]["b"], settings.thumbWidth + 2 + 10, 7, 0, 0xffffff, 70);
		...
		drawOval(second["over"]["a"], settings.thumbWidth + 2 + 10, 41, 0, 0x000000, 100);
		drawOval(second["over"]["b"], settings.thumbWidth + 2 + 10, 7, 0, 0x000000, 100);
		...
		drawOval(third["normal"]["a"], second["normal"]["a"]._width + 2, 1, 0, 0xdfdfdf, 16);
		drawOval(third["normal"]["b"], second["normal"]["a"]._width + 2, 1, 0, 0xdfdfdf, 16);
		drawOval(third["normal"]["c"], 1, settings.thumbHeight + 2 + 42 + 6, 0, 0xdfdfdf, 16);
		drawOval(third["normal"]["d"], 1, settings.thumbHeight + 2 + 42 + 6, 0, 0xdfdfdf, 16);
	...
	private function onLoadInit(mc:MovieClip) {
		...
		Tweener.addTween(img, { _alpha:100, time: settings.fadeInAnimationTime, transition: "linear" } );
