...
class oxylus.template.portfolio.thumbSlider extends MovieClip
{
	...
	public function setNode(n:XMLNode, settings_:Object) {
		...
		url = String(node.parentNode.parentNode.parentNode.parentNode.parentNode.parentNode.parentNode.firstChild.nextSibling.attributes.url 
						+ node.parentNode.parentNode.parentNode.parentNode.parentNode.attributes.url + node.parentNode.parentNode.attributes.url
						+ node.attributes.url);
		...
		drawOval(first["normal"]["a"], tw + 2, 1, 0, 0x7c7c7c, 100);
		drawOval(first["normal"]["b"], tw + 2, 1, 0, 0x7c7c7c, 100);
		drawOval(first["normal"]["c"], 1, th, 0, 0x7c7c7c, 100);
		drawOval(first["normal"]["d"], 1, th, 0, 0x7c7c7c, 100);
		...
		drawOval(first["over"]["a"], tw + 2, 1, 0, 0xf3f3f3, 100);
		drawOval(first["over"]["b"], tw + 2, 1, 0, 0xf3f3f3, 100);
		drawOval(first["over"]["c"], 1, th, 0, 0xf3f3f3, 100);
		drawOval(first["over"]["d"], 1, th, 0, 0xf3f3f3, 100);
		...
		drawOval(second["normal"]["b"], tw + 2 + 10, 5, 0, 0x000000, 70);
		...
		drawOval(second["over"]["b"], tw + 2 + 10, 5, 0, 0xffffff, 100);
		...
		drawOval(third["normal"]["a"], second["normal"]["a"]._width + 2, 1, 0, 0x232323, 70);
		drawOval(third["normal"]["b"], second["normal"]["a"]._width + 2, 1, 0, 0x232323, 70);
		drawOval(third["normal"]["c"], 1, th + 2 + 5 + 5, 0, 0x232323, 70);
		drawOval(third["normal"]["d"], 1, th + 2 + 5 + 5, 0, 0x232323, 70);
