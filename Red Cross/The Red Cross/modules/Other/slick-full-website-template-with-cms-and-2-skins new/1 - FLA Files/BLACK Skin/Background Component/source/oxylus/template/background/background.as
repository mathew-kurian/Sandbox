...
class oxylus.template.background.background extends MovieClip 
{
	...
	public function background() {
		...
		/**
		 * this will load the menu and all the other components
		 */
	...
	/**
	 * this will resize the entire website
	 * the min width is 980
	 * the min height is 600
	 * you can modify these if you want the website to keep resizing under these values
	 * @param	w
	 * @param	h
	 */
