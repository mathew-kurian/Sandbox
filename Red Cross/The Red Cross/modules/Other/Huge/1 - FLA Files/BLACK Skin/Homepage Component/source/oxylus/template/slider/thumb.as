...
class oxylus.template.slider.thumb extends MovieClip
{
	...
	public function setNode(n:XMLNode, settings_:Object, pMainU:String, pMainT:String ) {
		...
		drawOval(second["normal"]["a"], settings.thumbWidth + 2 + 10, 5, 0, 0x000000, 70);
		drawOval(second["normal"]["b"], settings.thumbWidth + 2 + 10, 29, 0, 0x000000, 70);
		...
		drawOval(second["over"]["a"], settings.thumbWidth + 2 + 10, 5, 0, 0xffffff, 100);
		drawOval(second["over"]["b"], settings.thumbWidth + 2 + 10, 29, 0, 0xffffff, 100);
		...
		drawOval(third["normal"]["c"], 1, settings.thumbHeight + 2 + 5 + 29, 0, 0x232323, 70);
		drawOval(third["normal"]["d"], 1, settings.thumbHeight + 2 + 5 + 29, 0, 0x232323, 70);
	...
	private function onLoadInit(mc:MovieClip) {
		...
		mc._x = mc._y = 7;
		Tweener.addTween(img, { _alpha:50, time: 1, transition: "linear" } );
