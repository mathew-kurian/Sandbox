...
class oxylus.template.clients.item extends MovieClip 
{
	...
	private function onLoadInit(mc:MovieClip) // executed when the image has fully loaded
	{
		...
		stroke["white"]._width = mc._width + 8;
		stroke["white"]._height = mc._height + 8;
		
		stroke["normal"]._width = stroke["over"]._width = mc._width + 2;
		stroke["normal"]._height = stroke["over"]._height = mc._height + 2;
