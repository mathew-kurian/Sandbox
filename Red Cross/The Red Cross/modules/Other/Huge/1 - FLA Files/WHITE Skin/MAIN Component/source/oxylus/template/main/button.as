...
class oxylus.template.main.button extends MovieClip 
{
	...
	public var subMenuPresent:Number = 0;
	...
	public function setNode(n:XMLNode) {
		...
		drawOval(bg, normal._width + 16, normal._height + 8, 6, 0x333333, 100);
		...
		if ((node.firstChild) && (node.firstChild.attributes.toggleSubMenu == 1)) {
			//bg._width -= 3;
		}
	}
	...
	public function onRollOver() {
		dispatchEvent( { target:this, type:"buttonRollOver", mc:this } );
	...
	private function onRollOut() {
		dispatchEvent( { target:this, type:"buttonRollOut", mc:this } );
