...
class oxylus.mp3Player.Tooltip03.Tooltip extends MovieClip
{
	...
	public function defaultValues()
	{
		...
		obj.backgroundRadius = 2;
		obj.backgroundWidth = 10;
		obj.backgroundHeight = 0;
		obj.tipOrientation = "bottom";
		obj.tipWidth = 7;
		obj.tipHeight = 16;
		obj.tipInclination = 3.5;
		obj.tipX = 0;
		...
		obj.myUnderlines.push(true);
		obj.myUnderlines.push(false);
	...
	public function show(myObj:Object)
	{
		...
		shortParse(myObj);
		Tweener.addTween(this, { _alpha:100, delay:obj.delay, time:obj.animationTime, _Blur_blurX:0, _Blur_blurY:0, transition:obj.animationType, onStart:Proxy.create(this, startInterval) } );
	}
	...
	public function hide(myObj:Object)
	{
		...
		Tweener.removeTweens(this);
		shortParse(myObj);
		Tweener.addTween(this, {_alpha:0, time:obj.animationTime, _Blur_blurX:20, _Blur_blurY:0, transition:obj.animationType});
	}
	...
	public function blur(blurX:Number, blurY:Number, mc:MovieClip) //function used for blurring the image
	{
	...
	public function setTheMc(mc:MovieClip) {
		refMc = mc;
	}
	/**
