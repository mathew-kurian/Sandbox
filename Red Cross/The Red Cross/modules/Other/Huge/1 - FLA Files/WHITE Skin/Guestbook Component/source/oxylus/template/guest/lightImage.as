...
class  oxylus.template.guest.lightImage extends MovieClip
{
	...
	private function onLoadInit(pMc:MovieClip):Void {
			...
			Utils2.getImage(pMc, true);
			
			if (resize[2] == "ratio") {
				var obj:Object = Utils2.getDims("fit", pMc._width, pMc._height, resize[0], resize[1], false);
				pMc._width = obj.w;
				pMc._height = obj.h;
				pMc._x = obj.x;
				pMc._y = obj.y;
