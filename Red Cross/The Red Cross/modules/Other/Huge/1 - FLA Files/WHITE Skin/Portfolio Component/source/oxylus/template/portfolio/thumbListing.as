...
class oxylus.template.portfolio.thumbListing extends MovieClip
{
	...
	public function setNode(n:XMLNode, settings_:Object, ndd:XMLNode) {
		...
		var str:Array = ndd.parentNode.attributes.url.split("/");
		
		url = String(ndd.parentNode.parentNode.previousSibling.attributes.url + "/" + str[1] + node.attributes.url);
		...
		drawOval(second["normal"]["b"], tw + 2 + 10, 29, 0, 0xffffff, 70);
		...
		drawOval(second["over"]["b"], tw + 2 + 10, 29, 0, 0x000000, 100);
		...
		drawOval(third["normal"]["c"], 1, th + 2 + 5 + 29, 0, 0xdfdfdf, 16);
		drawOval(third["normal"]["d"], 1, th + 2 + 5 + 29, 0, 0xdfdfdf, 16);
