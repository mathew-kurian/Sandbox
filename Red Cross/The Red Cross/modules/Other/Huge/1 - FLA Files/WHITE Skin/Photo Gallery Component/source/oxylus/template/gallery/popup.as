...
class oxylus.template.gallery.popup extends MovieClip
{
	 ...
	 * @param	settings_
	 */
	public function setNode(n:XMLNode, pM:Number, settings_:Object) {
	...
	/**
	 * this will handle the loading and take proper action regarding of the media nature, if it'a video or image
	 */
	...
	/**
	 * function executed when one image loaded
	 * @param	mc
	 */
