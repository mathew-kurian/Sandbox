...
/* 
=================================================
# Filename : skeleton3.css.php
# Description : Dynamic CSS rules for skeleton 3
...
include( ( file_exists( PATH_ROOT . DS . 'calc_skeleton3.php' ) ) ? PATH_ROOT . DS . 'calc_skeleton3.php' : PATH_ROOT . DS . 'calc.php' );
...
#tpmod-breadcrumb {
    height: 48px;
    background:url(../images/bgbreadcrumb.png) no-repeat left;
    margin-left:-25px;
    margin-right:-<?php echo $tpgutter; ?>px;
    margin-top:-<?php echo $tpgutter; ?>px;
...
.tpmod-breadcrumb-inner {
    ...
    background:url(../images/bgbreadcrumb.png) no-repeat right;
    margin-right:-10px;
...
.tp-tittle-date {
    background: url("../images/bgtitledate1.png") right top no-repeat;
	width:100px;
    height: 123px;
	float:right;
    color: #FFF;
    margin-right: -<?php echo $tpgutter+25; ?>px;
    margin-left: <?php echo $tpgutter; ?>px;
    overflow: hidden;
    display: block;
...
.leading_article{ 
    margin-right: -<?php echo $tpgutter + 5; ?>px; 
}
/*mod tpnewsticker*/
ul#tpmoostick {
    margin-top: 8px;
...
#tpmod-right div.moduletable-badgehot h3,
#tpmod-left div.moduletable-badgehot h3 {
    background:url(../images/badgehot1.png) no-repeat top left;
    margin-right:-<?php echo $tpgutter + 1; ?>px;
    margin-left:-28px;
    text-align: right;
...
#tpmod-right div.moduletable-badgenew h3,
#tpmod-left div.moduletable-badgenew h3 {
    background:url(../images/badgenew1.png) no-repeat top left;
    margin-right:-<?php echo $tpgutter + 1; ?>px;
    margin-left:-28px;
    text-align: right;
    }
...
#tpmod-left div.moduletable-badgenew h3
{
    width:<?php echo $tpwidth_blockleft - $tpgutter + 1; ?>px;
