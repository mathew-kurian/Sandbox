...
<table class="adminform table_list" width="100%" cellpadding="0" cellspacing="0">
	<tr>
	...
	<tr>
		<td width="150"><label for="title"><?php echo JText::_( 'Title' ); ?></label></td>
		<td>
			<input class="inputbox" type="text" id="title" name="title" size="30" maxlength="100" value="<?php echo $this->escape($this->article->title); ?>" />
...
<fieldset>
	...
	<table class="adminform table_list" width="100%" cellpadding="0" cellspacing="0">
		<tr>
			<td class="key" width="150"><label for="sectionid"><?php echo JText::_( 'Section' ); ?></label></td>
		...
		<tr>
			...
			<td><input type="text" id="created_by_alias" name="created_by_alias" size="30" maxlength="100" value="<?php echo $this->article->created_by_alias; ?>" class="inputbox" /></td>
		</tr>
		<tr>
...
<fieldset>
	...
	<tr valign="top">
		<td>
			...
			<br /><textarea rows="5" cols="50" class="inputbox" id="metadesc" name="metadesc"><?php echo str_replace('&','&amp;',$this->article->metadesc); ?></textarea>
	</td>
	</tr>
	<tr valign="top">
		<td>
			<label for="metakey"><?php echo JText::_( 'Keywords' ); ?></label>
			<br /><textarea rows="5" cols="50" class="inputbox" id="metakey" name="metakey"><?php echo str_replace('&','&amp;',$this->article->metakey); ?></textarea>
		</td>
	</tr>
	</table>
</fieldset>
