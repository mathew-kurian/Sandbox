...
window.addEvent('domready',function(){
	var hs8 = new noobSlide({
		...
		<?php endif; ?>
		mode: '<?php echo $mode; ?>',
		handles: $ES('span','mootabs_handles3'),
		onWalk: function(currentItem,currentHandle){
			$$(this.handles,mootabs_handles3).removeClass('active');
			$$(currentHandle,mootabs_handles3[this.currentIndex]).addClass('active');
		}
	});
	var mootabs_handles3 = $ES('span','mootabs_handles3');
	hs8.addHandleButtons(mootabs_handles3);
	hs8.walk(0)
});
