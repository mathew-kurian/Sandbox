...
/* 
=================================================
# Filename : skeleton1.css.php
# Description : Dynamic CSS rules for skeleton 1
...
include( ( file_exists( PATH_ROOT . DS . 'calc_skeleton1.php' ) ) ? PATH_ROOT . DS . 'calc_skeleton1.php' : PATH_ROOT . DS . 'calc.php' );
...
{
    width:<?php echo $tpwidth_blockleft - ($tpgutter * 5) - 3; ?>px;
