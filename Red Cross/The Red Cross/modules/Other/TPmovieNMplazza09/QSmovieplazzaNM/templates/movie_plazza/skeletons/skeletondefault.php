...
<jdoc:include type="message" />
	<div id="tpwrapper-global" align="center">
		<div id="tpwrapper-page">
			...
			<!-- ======= BLOCK HEAD  ======= -->
			<div id="tpblock-head">
				<div id="tpblock-head-inner">
					<div id="tpdiv-logo"><a href="<?php JURI :: base(); ?>"><h1><?php echo $this->fw->params->get('tp_logotext');?></h1></a></div>
					<div id="tpmod-banner"><jdoc:include type="modules" name="banner" style="raw" /></div>
			...
			<div id="tpblock-tpmenu">
				<?php $xhtml = ($this->loadModuleCufon('tpblock-tpmenu')) ? 'xhtmlcufon' : 'xhtmltp'; ?>
				<div id="tpmod-user8"><jdoc:include type="modules" name="user8" style="<?php echo $xhtml; ?>" /></div>
				<div class="clrfix"></div>
			</div>
			<?php endif; ?>
			...
			<div id="tpwrapper-footer">
				...
				<div id="tpblock-footerleft">
					<div>
						<img src="templates/<?php echo $this->fw->template; ?>/images/logofooter.png" alt="logo footer" border="0" class="pngfix" width="20" height="20" align="left"/>
						Designed by TemplatePlazza shared at <a href="http://www.nemesismedias.com" target="_blank"><strong>Nemesismedia</strong></a></div>
			  </div>
				<?php if($tp->user3) : ?>
				<!-- ======= BLOCK FOOTERRIGHT  ======= -->
