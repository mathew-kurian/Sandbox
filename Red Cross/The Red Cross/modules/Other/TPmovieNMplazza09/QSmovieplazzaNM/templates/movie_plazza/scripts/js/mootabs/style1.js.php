...
window.addEvent('domready',function(){
	var hs8 = new noobSlide({
		...
		<?php endif; ?>
		mode: '<?php echo $mode; ?>',
		handles: $ES('span','mootabs_handles1'),
		onWalk: function(currentItem,currentHandle){
			$$(this.handles,mootabs_handles1).removeClass('active');
			$$(currentHandle,mootabs_handles1[this.currentIndex]).addClass('active');
		}
	});
	var mootabs_handles1 = $ES('span','mootabs_handles1');
	hs8.addHandleButtons(mootabs_handles1);
	hs8.walk(0)
});
