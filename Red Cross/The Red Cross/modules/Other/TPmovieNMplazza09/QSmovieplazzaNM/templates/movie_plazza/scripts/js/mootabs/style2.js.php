...
window.addEvent('domready',function(){
	var hs8 = new noobSlide({
		...
		<?php endif; ?>
		mode: '<?php echo $mode; ?>',
		handles: $ES('span','mootabs_handles2'),
		onWalk: function(currentItem,currentHandle){
			$$(this.handles,mootabs_handles2).removeClass('active');
			$$(currentHandle,mootabs_handles2[this.currentIndex]).addClass('active');
		}
	});
	var mootabs_handles2 = $ES('span','mootabs_handles2');
	hs8.addHandleButtons(mootabs_handles2);
	hs8.walk(0)
});
