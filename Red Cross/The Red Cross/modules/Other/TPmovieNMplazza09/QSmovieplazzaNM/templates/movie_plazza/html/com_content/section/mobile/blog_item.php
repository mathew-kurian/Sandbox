...
<div class="tp-sk-all-wrp">
	<div class="tp-sk-all-wrp-inner">
		<div class="tp-sk-all-date-wrp">
			<div class="tp-sk-all-date-date"><?php echo JHTML::_('date', $this->item->created, '%d'); ?></div>
			<div class="tp-sk-all-date-month"><?php echo JHTML::_('date', $this->item->created, '%b'); ?></div>
            <div class="tp-sk-all-date-year"><?php echo JHTML::_('date', $this->item->created, '%Y'); ?></div>
		</div>
		...
		<div class="tp-sk-all-section">
			...
			<?php
			echo '<span><a href="'.JRoute::_(ContentHelperRoute::getCategoryRoute($this->item->catslug, $this->item->sectionid)).'">';
