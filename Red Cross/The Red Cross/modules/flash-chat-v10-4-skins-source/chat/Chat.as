...
import flash.external.ExternalInterface;
	...
	public class Chat extends MovieClip 
	{
		...
		{   
			trace("Flash Chat v1.504 Deluxe Engine");
			trace("----------------------------------------------------------");
			trace("Created by Sven Kohn");
			trace("(C) 2010 by Mindprobe - www.mind-probe.com");
...
// ***************************************************************************************************************************************
			...
			function onMessageSend():void
			{
				...
				else
				{
					...
					sa.addText("<font color='" + chatTextColor + "'><font color='" + chatLinkColor + "'>/private [username] [message]</font> - Send private pop-up chat window to user</font>");
