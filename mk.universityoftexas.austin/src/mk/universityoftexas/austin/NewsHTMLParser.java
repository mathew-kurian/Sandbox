...
public class NewsHTMLParser extends ThreadWorker {
	...
	public void postExecute() throws Exception {
		((Main) AVE.MAIN).setNews((ImageView) ((Main) AVE.MAIN).findViewById(R.id.home_news_1), AVE.NEWS_DOWNLOADED_IMAGE_1, AVE.NEWS_DETAILS_1);
