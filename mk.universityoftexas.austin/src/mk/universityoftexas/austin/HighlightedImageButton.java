...
public class HighlightedImageButton extends ImageView implements OnTouchListener{
	...
	public HighlightedImageButton(Context context, AttributeSet attrs, int id) {
	...
	public void onDraw(Canvas canvas) {
		...
		try{
			...
			Log.d("HighlightedImageButton", "onDraw error", "Red");
