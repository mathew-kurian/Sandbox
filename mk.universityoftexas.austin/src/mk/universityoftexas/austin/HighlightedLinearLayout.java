...
public class HighlightedLinearLayout extends LinearLayout implements OnTouchListener{
	...
	public HighlightedLinearLayout(Context context, AttributeSet attrs) {
		super(context, attrs);
		setOnTouchListener(this);
	}
	@Override
	public void onDraw(Canvas canvas) {
		...
		try{
			...
			Log.d("HighlightedLinearLayout", "onDraw error", "Red");
