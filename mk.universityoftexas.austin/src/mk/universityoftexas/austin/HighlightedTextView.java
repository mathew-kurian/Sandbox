...
public class HighlightedTextView extends TextView implements OnTouchListener{
	...
	public HighlightedTextView(Context context, AttributeSet attrs, int styleid) {
	...
	public void onDraw(Canvas canvas) {
		...
		try{
			...
			Log.d("HighlightedTextView", "onDraw error", "Red");
