...
*/
      ...
      if (!self.ispage || (!cap.cantouch && !cap.isieold && !cap.isie9mobile)) {
        ...
        if(self.opt.cursorvclass !== '')
          cursor.addClass(self.opt.cursorvclass);
        ...
        rail.css({width:rail.width+"px",'zIndex':self.zindex, cursor:"default"});
        if(self.opt.railvclass !== ''){
          rail.addClass(self.opt.railvclass)    
        }
...
// init HORIZ
        ...
        if (self.opt.horizrailenabled) {
          ...
          if(self.opt.cursorhclass !== '')
            cursor.addClass(self.opt.cursorhclass);
          ...
          railh.css({height:railh.height+"px",'zIndex':self.zindex});
          if(self.opt.railhclass !== ''){
            railh.addClass(self.opt.railhclass)  
          }
