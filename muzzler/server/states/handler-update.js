...
require('elixir/cstate').extend({
    ...
    pauseSong : function(){
        if(typeof this.private().psong !== 'undefined'){
            ...
            this.fireListeners('audio', 'pause', this.private().psong, this.private().currentSid);
        }
    },
    resumeSong : function(){
        if(typeof this.private().psong !== 'undefined'){
            this.private().psong.play();
            this.fireListeners('audio', 'resume', this.private().psong, this.private().currentSid);
        }
    },
    stopSong : function(){
        if(typeof this.private().psong !== 'undefined'){
            ...
            this.fireListeners('audio', 'stop', this.private().psong, this.private().currentSid);
        }
    },
    skipSongTo : function(a){        
        if(typeof this.private().psong !== 'undefined'){
            try { this.private().psong.currentTime = a; } catch(e){}
            this.fireListeners('audio', 'skippedto', this.private().psong, this.private().currentSid);
        }
    },
